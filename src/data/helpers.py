...
def get_vocab(args):
    vocab = Vocab()
    if args.model in ["bert", "mmbt", "concatbert",'latefusion_pdf','img','latefusion_video','video','concat_video_text','simple_latefusion_video','latefusion_video_attention','latefusion_video_attention_lite','latefusion_video_attention_improved','latefusion_video_text']:
...
def get_data_loaders(args):
    tokenizer = (
        ...
        BertTokenizer.from_pretrained(args.bert_model, do_lower_case=True).tokenize
        if args.model in ["bert", "mmbt", "concatbert",'latefusion_pdf','latefusion_video','video','concat_video_text','simple_latefusion_video','latefusion_video_attention','latefusion_video_attention_lite','latefusion_video_attention_improved','latefusion_video_text']
        else str.split
    )
