...
class VideoTextDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return sentence, segment, video_frames, label, sample_id, original_id
...
def collate_video_text_fn(batch, args):
    ...
    Returns:
        整理后的批次数据
    """
    sentences, segments, video_frames, labels, sample_ids, original_ids = zip(*batch)
    ...
    return sentences, attention_mask, segments, video_frames, labels, sample_ids, original_ids
